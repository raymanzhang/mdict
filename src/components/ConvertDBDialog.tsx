      ...
      <>
        ...
        <IonList style={{ 
          ...
          overflowY: 'auto'
            ...
            <IonItem lines="none">
              <IonLabel>
                <h3>{t('Replace Original File')}</h3>
                <IonNote>
                  {isProfileInUse 
                    ? t('File is currently in use and cannot be replaced')
                    : t('Automatically replace original MDX/MDD files after successful conversion')}
                </IonNote>
              </IonLabel>
              <IonCheckbox
                slot="start"
                checked={options.removeOldFiles && !isProfileInUse}
